...
// Navigation secondaire (drawer "Plus")
const MORE_NAV = [
  { href: "/carnet",      label: "Carnet",      icon: "📖", desc: "Historique de tes séances" },
  { href: "/courses",     label: "Courses",     icon: "🛒", desc: "Liste de courses de la semaine" },
  { href: "/historique",  label: "Statistiques",icon: "📊", desc: "Évolution, poids, habitudes" },
          ...
          <div style={{
            ...
            <div style={{ padding: "4px 0 16px" }}>
                  ...
                  <Link key={link.href} href={link.href}
                    ...
                    <div>
                      <p style={{ ...mono, fontSize: 12, letterSpacing: 1, fontWeight: 700,
                        color: isActive ? "#c0392b" : "#1a1a1a" }}>
                        {link.label.toUpperCase()}
                      </p>
                      <p style={{ fontSize: 12, color: "#7a7268", marginTop: 1 }}>{link.desc}</p>
                    </div>
                    {isActive && <span style={{ marginLeft: "auto", color: "#c0392b" }}>●</span>}
                  </Link>
                );
              })}
              ...
              <button onClick={() => { signOut({ callbackUrl: "/login" }); setDrawerOpen(false); }}
                ...
                <p style={{ ...mono, fontSize: 12, letterSpacing: 1, fontWeight: 700, color: "#c0392b" }}>
                  SE DÉCONNECTER
                </p>
              </button>
            </div>
