...
export type SessionType = "STRENGTH" | "CARDIO" | "HIIT" | "YOGA_STRETCH" | "FULL_BODY" | "REST" | "RUNNING" | "CYCLING" | "CROSSFIT" | "MARTIAL_ARTS";
...
const SPORTS: { icon: string; name: string; type: SessionType; category: string }[] = [
  ...
  { icon: "💪", name: "Full Musculation",       type: "STRENGTH",     category: "Force" },
  { icon: "🏃", name: "Course à pied",          type: "RUNNING",      category: "Running" },
  { icon: "🏃", name: "Trail",                  type: "RUNNING",      category: "Running" },
  { icon: "🏃", name: "Fractionné / Intervalle",type: "RUNNING",      category: "Running" },
  { icon: "🏃", name: "Footing récupération",   type: "RUNNING",      category: "Running" },
  { icon: "🚴", name: "Vélo route / Gravel",    type: "CYCLING",      category: "Cyclisme" },
  { icon: "🚴", name: "VTT",                    type: "CYCLING",      category: "Cyclisme" },
  { icon: "🚴", name: "Home trainer / Zwift",   type: "CYCLING",      category: "Cyclisme" },
  { icon: "🔗", name: "CrossFit – WOD",         type: "CROSSFIT",     category: "CrossFit / HYROX" },
  { icon: "🔗", name: "HYROX – Simulation",     type: "CROSSFIT",     category: "CrossFit / HYROX" },
  { icon: "🔗", name: "Fitness fonctionnel",    type: "CROSSFIT",     category: "CrossFit / HYROX" },
  { icon: "🥋", name: "Arts martiaux",          type: "MARTIAL_ARTS", category: "Arts Martiaux" },
  { icon: "🥋", name: "Karaté / Taekwondo",    type: "MARTIAL_ARTS", category: "Arts Martiaux" },
  { icon: "🥊", name: "Boxe anglaise",          type: "MARTIAL_ARTS", category: "Arts Martiaux" },
  { icon: "🤼", name: "Judo / Lutte / Grappling",type: "MARTIAL_ARTS",category: "Arts Martiaux" },
  ...
  { icon: "🚶", name: "Marche rapide / Rando",  type: "CARDIO",       category: "Cardio" },
  { icon: "⚽", name: "Football",               type: "HIIT",         category: "Sports collectifs" },
  { icon: "🏀", name: "Basketball",             type: "HIIT",         category: "Sports collectifs" },
  { icon: "🎾", name: "Tennis",                 type: "HIIT",         category: "Sports collectifs" },
  { icon: "🏸", name: "Badminton",              type: "HIIT",         category: "Sports collectifs" },
  { icon: "🏐", name: "Volleyball",             type: "HIIT",         category: "Sports collectifs" },
  { icon: "🤾", name: "Handball",               type: "HIIT",         category: "Sports collectifs" },
  { icon: "🏒", name: "Hockey",                 type: "HIIT",         category: "Sports collectifs" },
  { icon: "🎱", name: "Squash / Padel",          type: "HIIT",         category: "Sports collectifs" },
  { icon: "🔥", name: "HIIT",                   type: "HIIT",         category: "Sports collectifs" },
...
const CATEGORIES = ["Force", "Running", "Cyclisme", "CrossFit / HYROX", "Arts Martiaux", "Cardio", "Sports collectifs", "Corps entier", "Bien-être", "Repos"];
